    ...
    <div class="row space-top">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input class="${'form-control' + (validEmail ? ' is-invalid' : '')}" id="email" type="text"
                    name="email">
            </div>
            <div class="form-group">
                <label class="form-control-label" for="password">Password</label>
                <input class="${'form-control' + (validPass ? ' is-invalid' : '')}" id="password"
                    type="password" name="password">
            </div>
            <div class="form-group">
                <label class="form-control-label" for="rePass">Repeat</label>
                <input class="${'form-control' + (validRePass ? ' is-invalid' : '')}" id="rePass"
