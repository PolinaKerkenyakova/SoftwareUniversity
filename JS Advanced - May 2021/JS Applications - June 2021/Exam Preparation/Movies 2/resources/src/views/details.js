...
const detailsTemplate = (movie, isOwner, like) => html`
<div class="row bg-light text-dark">
    ...
    <div class="col-md-4 text-center">
        ...
        <a class="btn btn-warning" href="/edit/${movie._id}">Edit</a>` : html`<a @click=${like} class="btn btn-primary" href="#">Like</a>`}
...
const userId = sessionStorage.getItem('userId')
    ...
    console.log(movie);
    ctx.render(detailsTemplate(movie, userId == movie._ownerId, like));
}