...
const replyForm = document.querySelector('.answer form');
const homeElement = document.querySelector('li a');
...
fetch(`http://localhost:3030/jsonstore/collections/myboard/posts/${localStorage.getItem('topicId')}`)
    .then(res => res.json())
    .then(function (res) {
        commentElement.appendChild(createHtmlTopic(Object.values(res)));
    });
